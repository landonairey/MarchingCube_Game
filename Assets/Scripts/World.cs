...
public class World : MonoBehaviour
{
    ...
    [HideInInspector] //hide becasue it will show a field in the inspector but you can't do anything with it
    public Texture2DArray terrainTexArray;

    /* //COMMENT OUT DAY NIGHT CYCLE CODE FROM B3AGZ
    ...
    */ //COMMENT OUT DAY NIGHT CYCLE CODE FROM B3AGZ
    ...
    void PopulateTextureArray()
    {
        ...
        //Initializes the Texture2DArray on awake. This fixes the size of the incoming textures.
        //make sure that the linked textures match the uv dimenions here and that they are read/write
        terrainTexArray = new Texture2DArray(512, 512, terrainTextures.Length, TextureFormat.ARGB32, false);
